  ...
  pmi:{
    ...
    npcs:[
      ...
      },
      {
        ...
        outs:{
          learn:{
            msg:'Hai costruito una connessione reale. +NETWORK +RADAR',
            stat:{
              NETWORK:2,
              RADAR:1
            }
          ...
          systemic:{
            msg:'Pensi in grande: cambiare il sistema, non solo navigarlo. +NETWORK +CLARITY +RADAR',
            stat:{
              NETWORK:2,
              CLARITY:1,
              RADAR:2
      ...
      },
      {
        ...
        dlg:{
          ...
          chs:[
            {
              t:'"Giovane" e "esperienza" sono criteri diversi. Posso chiederti quali risultati specifici mancano alla mia valutazione?',
              out:'ask'
            },
            {
              t:'Capisco, grazie per la considerazione.',
              out:'accept'
            },
            {
              t:'Questo tipo di commento mi aiuterebbe di più se fosse ancorato a KPI concreti, non all\'età.',
              out:'direct'
            }
          ]
        },
        outs:{
          ask:{
            msg:'Hai spostato la conversazione su criteri oggettivi. +CLARITY +VOICE',
            stat:{
              CLARITY:2,
              VOICE:1
            }
          ...
          accept:{
            msg:'Hai accettato un veto non motivato. -VOICE',
            stat:{
              VOICE:-1
            }
          },
          direct:{
            msg:'Hai nominato il problema con precisione. +VOICE +RADAR',
            stat:{
              VOICE:2,
              RADAR:2
            }
        ...
        db:{
          pat:'L\'ageismo come proxy del sessismo nei ruoli tech',
      ...
      },
      {
        id:'pmi_cliente',
        sprite:'col',
        label:'Call con Cliente',
        type:'npc',
        required:false,
        gridX:11,
        gridY:4,
        dlg:{
          spk:'📞 Cliente Esterno — Ing. Rossi',
          color:'#ffb74d',
          ...
          chs:[
            {
              t:'Sono io la responsabile di questo progetto. Le competenze che cerca sono le mie.',
              out:'hold'
            },
            {
              t:'Certamente, le passo il mio manager.',
              out:'step_back'
            },
            {
              t:'Posso chiederle cosa intende per "più esperto"? Voglio capire se c\'è una lacuna specifica.',
              out:'probe'
            }
          ]
        },
        outs:{
          hold:{
            msg:'Hai tenuto la posizione con chiarezza. +VOICE +SKILL',
            stat:{
              VOICE:2,
              SKILL:1
            }
          ...
          probe:{
            msg:'Hai reso visibile il bias chiedendo criteri. +RADAR +VOICE',
            stat:{
              RADAR:2,
              VOICE:1
            }
        ...
        db:{
          pat:'Il "parlare con il responsabile" come svalutazione dell\'expertise femminile',
      ...
      },
      {
        ...
        gridY:9,
        dlg:{
          spk:'❤️ Marta — Responsabile Qualità (Alleata)',
          color:'#e53935',
          ...
          chs:[
            {
              t:'Sì, assolutamente. Cosa ha funzionato meglio per te?',
              out:'learn'
            },
            {
              t:'Grazie. Ma non mi piace dover "giocare" questo tipo di gioco.',
              out:'resist'
            },
            {
              t:'Costruiamo qualcosa insieme — documentiamo i risultati del team in modo sistematico.',
              out:'systemic'
            }
          ]
        },
        outs:{
          learn:{
            msg:'Hai acquisito tattiche concrete da chi ha esperienza diretta. +NETWORK +SKILL',
            stat:{
              NETWORK:2,
              SKILL:1
            }
          ...
          resist:{
            msg:'La resistenza è legittima — ma il gioco si gioca comunque. +RADAR -ENERGY',
            stat:{
              RADAR:1,
              ENERGY:-1
            }
          ...
          systemic:{
            msg:'Proponi un sistema che aiuta tutto il team. +NETWORK +CLARITY +RADAR',
            stat:{
              NETWORK:2,
              CLARITY:1,
              RADAR:1
        ...
        db:{
          pat:'La visibilità come lavoro strategico nelle PMI',
      ...
      },
      {
        ...
        dlg:{
          ...
          chs:[
            {
              t:'Implemento un modello di anomaly detection (Isolation Forest o LSTM) su edge device locale.',
              out:'edge'
            },
            {
              t:'Prima definisco con il responsabile quali fermi vogliamo prevenire e con che anticipo — poi scelgo il modello.',
              out:'frame'
            },
            {
              t:'Con 6 mesi di dati e budget limitato, propongo regole statistiche (z-score rolling) — interpretabili e manutenibili.',
              out:'simple'
            }
          ]
        },
        outs:{
          edge:{
            msg:'Soluzione tecnica corretta ma complessa per il contesto. +SKILL',
            stat:{
              SKILL:1
            }
          },
          frame:{
            msg:'Business first. +SKILL +CLARITY +RADAR',
            stat:{
              SKILL:1,
              CLARITY:2,
              RADAR:1
          ...
          simple:{
            msg:'La soluzione semplice e manutenibile batte il modello ML in contesti senza infrastruttura. +SKILL +CLARITY',
            stat:{
              SKILL:2,
              CLARITY:1
            }
        ...
        db:{
          pat:'Predictive maintenance nelle PMI: il divario tra teoria e pratica',
  ...
  startup:{
    ...
    npcs:[
      ...
      },
      {
        ...
        outs:{
          learn:{
            msg:'Hai imparato una strategia concreta. +NETWORK +SKILL',
            stat:{
              NETWORK:2,
              SKILL:1
            }
          ...
          systemic:{
            msg:'Proponi un cambiamento strutturale. +NETWORK +RADAR +CLARITY',
            stat:{
              NETWORK:2,
              RADAR:2,
              CLARITY:1
      ...
      },
      {
        ...
        dlg:{
          ...
          chs:[
            {
              t:'Sono io l\'architetta tecnica. Posso mostrarti l\'architettura e il codice se vuoi validare la scelta.',
              out:'show'
            },
            {
              t:'Stiamo valutando di espandere il team tecnico — possiamo parlarne dopo la due diligence?',
              out:'deflect'
            },
            {
              t:'Interessante domanda. Hai mai chiesto la stessa cosa a un founder maschio con il mio profilo?',
              out:'challenge'
            }
          ]
        },
        outs:{
          show:{
            msg:'Lasci parlare il lavoro. +SKILL +VOICE',
            stat:{
              SKILL:2,
              VOICE:1
            }
          ...
          deflect:{
            msg:'Hai evitato il confronto. +ENERGY -RADAR',
            stat:{
              ENERGY:1,
              RADAR:-1
            }
          ...
          challenge:{
            msg:'Hai nominato il doppio standard. +VOICE +RADAR',
            stat:{
              VOICE:2,
              RADAR:2
            }
        ...
        db:{
          pat:'Il "chi è il tecnico vero" nei pitch con founder donna',
      ...
      },
      {
        id:'startup_burnout',
        sprite:'col',
        label:'Stand-up mattutino',
        type:'npc',
        required:false,
        gridX:11,
        gridY:8,
        dlg:{
          spk:'😮‍💨 Collega — Luca (esausto)',
          color:'#ce93d8',
          ...
          chs:[
            {
              t:'"Committed" e "disponibile 24/7" non sono la stessa cosa. Ho imparato a distinguere urgenza reale da urgenza culturale.',
              out:'reframe'
            },
            {
              t:'Anche io faccio fatica. Penso che dobbiamo parlarne come team col founder.',
              out:'collective'
            },
            {
              t:'Io lavoro il weekend se il progetto lo richiede davvero, ma ho imparato a chiedere sempre: urgente per cosa, entro quando.',
              out:'criteria'
            }
          ]
        },
        outs:{
          reframe:{
            msg:'Hai distinto urgenza reale da cultura del sempre-disponibile. +CLARITY +ENERGY',
            stat:{
              CLARITY:2,
              ENERGY:1
            }
          ...
          collective:{
            msg:'Proponi una soluzione collettiva. +NETWORK +VOICE',
            stat:{
              NETWORK:1,
              VOICE:2
            }
          ...
          criteria:{
            msg:'Strumento pratico: rendere visibili i criteri dell\'urgenza. +CLARITY +RADAR +SKILL',
            stat:{
              CLARITY:1,
              RADAR:2,
              SKILL:1
        ...
        db:{
          pat:'La cultura del crunch nelle startup e il suo costo asimmetrico',
      ...
      },
      {
        ...
        gridY:9,
        dlg:{
          spk:'❤️ Chiara — Product Manager (Alleata)',
          color:'#e53935',
          ...
          chs:[
            {
              t:'Sì — documentare è il primo passo per rendere visibile quello che succede. Come lo strutturi?',
              out:'yes'
            },
            {
              t:'Non voglio sembrare paranoica o in cerca di conflitti.',
              out:'fear'
            },
            {
              t:'Potremmo usare questo log anche per proporre al founder un sistema di attribuzione delle idee più esplicito.',
              out:'systemic'
            }
          ]
        },
        outs:{
          yes:{
            msg:'Hai scelto di documentare. +NETWORK +CLARITY',
            stat:{
              NETWORK:2,
              CLARITY:1
            }
          ...
          fear:{
            msg:'La paura di sembrare "difficile" è esattamente quello che rende il pattern invisibile. +RADAR -VOICE',
            stat:{
              RADAR:1,
              VOICE:-1
            }
          ...
          systemic:{
            msg:'Dal log individuale a una policy di team. +NETWORK +RADAR +CLARITY',
            stat:{
              NETWORK:2,
              RADAR:2,
              CLARITY:1
        ...
        db:{
          pat:'Il "manterrupting" e l\'appropriazione delle idee nelle startup',
      ...
      },
      {
        ...
        dlg:{
          ...
          chs:[
            {
              t:'Propongo outcome metrics: per ogni use case, misuro se l\'utente ha raggiunto l\'obiettivo dichiarato.',
              out:'outcome'
            },
            {
              t:'Introduco una North Star Metric legata al valore business e la decompongo in leading indicators misurabili.',
              out:'north_star'
            },
            {
              t:'Faccio prima user research qualitativa per capire cosa "aiutare" significa per gli utenti reali.',
              out:'research'
            }
          ]
        },
        outs:{
          outcome:{
            msg:'Task completion > session length. +SKILL +CLARITY',
            stat:{
              SKILL:2,
              CLARITY:1
            }
          ...
          north_star:{
            msg:'Framework classico ma solido. +SKILL +RADAR',
            stat:{
              SKILL:2,
              RADAR:1
            }
          ...
          research:{
            msg:'Research before metrics. +SKILL +CLARITY +RADAR',
            stat:{
              SKILL:1,
              CLARITY:2,
              RADAR:2
        ...
        db:{
          pat:'Vanity metrics vs outcome metrics nei prodotti AI',
  ...
  consulenza:{
    ...
    npcs:[
      ...
      },
      {
        ...
        outs:{
          learn:{
            msg:'Hai acquisito una strategia trasferibile. +NETWORK +SKILL',
            stat:{
              NETWORK:2,
              SKILL:1
            }
          ...
          systemic:{
            msg:'Pensi al cambiamento strutturale. +NETWORK +CLARITY +RADAR',
            stat:{
              NETWORK:2,
              CLARITY:1,
              RADAR:2
      ...
      },
      {
        ...
        dlg:{
          ...
          chs:[
            {
              t:'Posso aiutarti questa volta, ma parliamo anche di come il team distribuisce il mentoring — non dovrebbe essere solo mio.',
              out:'boundary_system'
            },
            {
              t:'Certo, vieni pure. Di cosa hai bisogno?',
              out:'yes'
            },
            {
              t:'Posso dedicarti 30 minuti mercoledì — prenota nel mio calendario.',
              out:'structure'
            }
          ]
        },
        outs:{
          boundary_system:{
            msg:'Aiuti e nomini il problema strutturale insieme. +VOICE +NETWORK +CLARITY',
            stat:{
              VOICE:1,
              NETWORK:1,
              CLARITY:1
          ...
          yes:{
            msg:'Aiuti senza confini. +ENERGY -CLARITY',
            stat:{
              ENERGY:1,
              CLARITY:-1
            }
          ...
          structure:{
            msg:'Confine professionale con disponibilità reale. +VOICE +ENERGY',
            stat:{
              VOICE:1,
              ENERGY:1
            }
        ...
        db:{
          pat:'Il mentoring non pagato come aspettativa implicita verso le donne',
      ...
      },
      {
        ...
        gridY:8,
        dlg:{
          spk:'👔 HR Senior — Compensation review',
          color:'#4fc3f7',
          ...
          chs:[
            {
              t:'Posso vedere la distribuzione del peer group — media, mediana, range? Senza nomi, solo statistiche.',
              out:'data'
            },
            {
              t:'Capisco. Posso chiederti allora quali sono i criteri per passare al livello successivo?',
              out:'redirect'
            },
            {
              t:'Ho fatto la mia ricerca di mercato — i dati di Glassdoor e Levels.fyi mostrano un range diverso. Possiamo parlarne?',
              out:'external'
            }
          ]
        },
        outs:{
          data:{
            msg:'Chiedi dati aggregati. +VOICE +CLARITY',
            stat:{
              VOICE:2,
              CLARITY:1
            }
          ...
          redirect:{
            msg:'Sposti il focus sulla progressione. +CLARITY +RADAR',
            stat:{
              CLARITY:1,
              RADAR:1
            }
          ...
          external:{
            msg:'Usi dati di mercato come leverage. +VOICE +SKILL',
            stat:{
              VOICE:2,
              SKILL:1
            }
        ...
        db:{
          pat:'Il gender pay gap nelle consulenze e come negoziare con dati',
      ...
      },
      {
        ...
        dlg:{
          ...
          chs:[
            {
              t:'Sì — e proponiamo al partner di formalizzare questo tipo di peer recognition nel processo di review.',
              out:'systemic'
            },
            {
              t:'Certo, con piacere. Come funziona concretamente?',
              out:'learn'
            },
            {
              t:'Sono dentro. Aggiungiamo anche una collega junior che merita visibilità.',
              out:'expand'
            }
          ]
        },
        outs:{
          systemic:{
            msg:'Proponi di istituzionalizzare il circolo. +NETWORK +RADAR +CLARITY',
            stat:{
              NETWORK:2,
              RADAR:2,
              CLARITY:1
          ...
          learn:{
            msg:'Entri nel sistema con intenzione di contribuire. +NETWORK +ENERGY',
            stat:{
              NETWORK:2,
              ENERGY:1
            }
          ...
          expand:{
            msg:'Estendi il cerchio verso chi è più indietro. +NETWORK +RADAR',
            stat:{
              NETWORK:3,
              RADAR:1
            }
        ...
        db:{
          pat:'Il circolo di mutuo riconoscimento come antidoto al credit gap',
      ...
      },
      {
        ...
        gridY:4,
        dlg:{
          spk:'💻 Sfida Tecnica — Consulenza 2',
          color:'#f7c46a',
          ...
          chs:[
            {
              t:'Costruisco un sistema di collaborative filtering solido — e documento esplicitamente cosa non è "come Amazon".',
              out:'build_honest'
            },
            {
              t:'Prima di toccare il codice, facilito una sessione con il partner e il cliente per riallineare le aspettative su cosa è fattibile.',
              out:'realign'
            },
            {
              t:'Propongo un proof of concept in 6 settimane su un segmento prodotto — risultati reali prima di promesse più grandi.',
              out:'poc'
            }
          ]
        },
        outs:{
          build_honest:{
            msg:'Costruisci e documenti onestamente. +SKILL +CLARITY',
            stat:{
              SKILL:2,
              CLARITY:1
            }
          ...
          realign:{
            msg:'Gestisci le aspettative prima ancora di iniziare. +CLARITY +RADAR +VOICE',
            stat:{
              CLARITY:2,
              RADAR:1,
              VOICE:1
          ...
          poc:{
            msg:'PoC prima delle grandi promesse. +SKILL +CLARITY',
            stat:{
              SKILL:1,
              CLARITY:2
            }
        ...
        db:{
          pat:'Il "gap tra promessa e delivery" nei progetti AI in consulenza',
...
const W3_NPCS = [
  ...
  },
  {
    ...
    dlg:{
      ...
      chs:[
        {
          t:'Grazie del feedback. Puoi mostrarmi una presentazione che ha funzionato bene con questo board?',
          out:'learn'
        },
        {
          t:'Apprezzo il consiglio. Hai notato se ci sono differenze in come i board member reagiscono a uomini e donne?',
          out:'probe'
        },
        {
          t:'Ho preparato una struttura pyramid principle — conclusione prima, poi evidenza. Posso condividertela per un feedback?',
          out:'share'
        }
      ]
    },
    outs:{
      learn:{
        msg:'Impari dal contesto specifico. +SKILL +NETWORK',
        stat:{
          SKILL:1,
          NETWORK:1
        }
      ...
      probe:{
        msg:'Cerchi dati sul doppio standard. +RADAR +CLARITY',
        stat:{
          RADAR:2,
          CLARITY:1
        }
      ...
      share:{
        msg:'Usi la struttura giusta e cerchi feedback proattivamente. +SKILL +CLARITY',
        stat:{
          SKILL:2,
          CLARITY:1
        }
    ...
    db:{
      pat:'La "executive presence" nei board meeting e il doppio standard di presentazione',
  ...
  },
  {
    ...
    dlg:{
      ...
      chs:[
        {
          t:'Domanda personale a parte — posso avere i dettagli scritti del ruolo, la compensation, e i tempi precisi?',
          out:'redirect'
        },
        {
          t:'La mia situazione personale la valuto io. Posso chiederti se questa domanda la fate anche ai candidati uomini?',
          out:'challenge'
        },
        {
          t:'Ho bisogno di più di venerdì per valutare. E le domande sulla famiglia non sono rilevanti per la mia decisione professionale.',
          out:'boundary'
        }
      ]
    },
    outs:{
      redirect:{
        msg:'Reindirizza su dati professionali. +CLARITY +VOICE',
        stat:{
          CLARITY:2,
          VOICE:1
        }
      ...
      challenge:{
        msg:'Nomini il doppio standard con precisione. +VOICE +RADAR',
        stat:{
          VOICE:2,
          RADAR:2
        }
      ...
      boundary:{
        msg:'Doppio confine: tempo e privacy. +VOICE +ENERGY +CLARITY',
        stat:{
          VOICE:2,
          ENERGY:1,
          CLARITY:1
    ...
    db:{
      pat:'Le domande illegali nei processi di mobilità interna e il "family penalty"',
  ...
  },
  {
    ...
    gridY:9,
    dlg:{
      spk:'❤️ Beatrice — VP Analytics (Alleata)',
      color:'#e53935',
      ...
      chs:[
        {
          t:'Ha senso. Come si dice in modo che suoni ambizioso ma non "troppo"?',
          out:'ask_how'
        },
        {
          t:'Non mi è mai piaciuta l\'idea di dover "vendere" me stessa così esplicitamente.',
          out:'resist'
        },
        {
          t:'Possiamo fare una sessione pratica in cui simulo quella conversazione con il mio director?',
          out:'practice'
        }
      ]
    },
    outs:{
      ask_how:{
        msg:'Cerchi il modo concreto per comunicare ambizione senza penalizzazioni. +CLARITY +SKILL',
        stat:{
          CLARITY:2,
          SKILL:1
        }
      ...
      resist:{
        msg:'La resistenza è comprensibile — il problema è che gli altri lo fanno. +RADAR -VOICE',
        stat:{
          RADAR:1,
          VOICE:-1
        }
      ...
      practice:{
        msg:'Role-playing pratico: il modo più efficace per prepararsi. +SKILL +CLARITY +ENERGY',
        stat:{
          SKILL:1,
          CLARITY:1,
          ENERGY:1
    ...
    db:{
      pat:'Dichiarare l\'ambizione nelle corporate: il rischio del backlash e come navigarlo',
  ...
  },
  {
    ...
    dlg:{
      ...
      chs:[
        {
          t:'Mappo immediatamente i dataset coinvolti: chi li ha creati, quando, per quale scopo.',
          out:'map'
        },
        {
          t:'Notifica immediata al DPO (Data Protection Officer) e al team legale.',
          out:'escalate'
        },
        {
          t:'Costruisco un inventario dei dati con classificazione di rischio.',
          out:'inventory'
        }
      ]
    },
    outs:{
      map:{
        msg:'Data lineage come primo passo. +SKILL +CLARITY',
        stat:{
          SKILL:2,
          CLARITY:1
        }
      ...
      escalate:{
        msg:'Il DPO deve saperlo subito. +VOICE +RADAR +CLARITY',
        stat:{
          VOICE:1,
          RADAR:1,
          CLARITY:2
      ...
      inventory:{
        msg:'Risk-based prioritization. +SKILL +RADAR',
        stat:{
          SKILL:2,
          RADAR:1
        }
    ...
    db:{
      pat:'GDPR e data governance nelle corporate: il ruolo del data scientist',
...
const W4_NPCS = [
  ...
  },
  {
    ...
    gridY:8,
    dlg:{
      spk:'👩‍💼 Cliente — Responsabile Acquisti',
      color:'#6af7c8',
      ...
      chs:[
        {
          t:'90 giorni di pagamento e 12 mesi di esclusiva cambiano significativamente il valore del contratto. Ho bisogno di rivedere la tariffa di conseguenza.',
          out:'reprice'
        },
        {
          t:'La clausola di esclusiva non è accettabile — limita la mia libertà professionale in modo sproporzionato.',
          out:'reject_exclusive'
        },
        {
          t:'Possiamo negoziare: 60 giorni o compenso per il ritardo? E l\'esclusiva la posso accettare ridotta a 3 mesi.',
          out:'negotiate'
        }
      ]
    },
    outs:{
      reprice:{
        msg:'Colleghi le condizioni contrattuali al prezzo. +VOICE +CLARITY',
        stat:{
          VOICE:2,
          CLARITY:1
        }
      ...
      reject_exclusive:{
        msg:'Linea chiara su ciò che non è negoziabile. +VOICE +ENERGY',
        stat:{
          VOICE:2,
          ENERGY:1
        }
      ...
      negotiate:{
        msg:'Proponi alternative concrete. +VOICE +SKILL +CLARITY',
        stat:{
          VOICE:1,
          SKILL:1,
          CLARITY:2
    ...
    db:{
      pat:'Le clausole contrattuali abusive e la negoziazione per freelance',
  ...
  },
  {
    ...
    gridY:4,
    dlg:{
      spk:'📊 Commercialista — Prima consulenza',
      color:'#6af7c8',
      ...
      chs:[
        {
          t:'Capisco la complessità. Può farmi un confronto numerico dei due scenari a 100k€ e 150k€ di fatturato?',
          out:'compare'
        },
        {
          t:'Quali sono i costi fissi esatti della SRL e il break-even rispetto al forfettario?',
          out:'details'
        },
        {
          t:'"Forse per ora" — su cosa basa questa valutazione? Ha altri parametri oltre al fatturato attuale?',
          out:'probe'
        }
      ]
    },
    outs:{
      compare:{
        msg:'Chiedi proiezioni numeriche concrete, non opinioni. +CLARITY +SKILL',
        stat:{
          CLARITY:2,
          SKILL:1
        }
      ...
      details:{
        msg:'Vuoi i numeri precisi per decidere autonomamente. +CLARITY +RADAR',
        stat:{
          CLARITY:2,
          RADAR:1
        }
      ...
      probe:{
        msg:'Questioniy il consiglio generico chiedendo i criteri. +RADAR +VOICE',
        stat:{
          RADAR:2,
          VOICE:1
        }
    ...
    db:{
      pat:'La pianificazione fiscale come competenza strategica per il lavoro autonomo',
  ...
  },
  {
    ...
    gridY:9,
    dlg:{
      spk:'❤️ Giulia — Community organizer (Alleata)',
      color:'#e53935',
      ...
      chs:[
        {
          t:'Sì — cosa serve concretamente per i prossimi 3 mesi per far partire la community?',
          out:'builder'
        },
        {
          t:'Mi interessa molto. Posso contribuire con sessioni su AI engineering — cosa ti manca di più?',
          out:'contribute'
        },
        {
          t:'Sono dentro. E conosco altre due professioniste che dovrebbero assolutamente essere nel nucleo fondatore.',
          out:'expand'
        }
      ]
    },
    outs:{
      builder:{
        msg:'Entri come builder, non solo come partecipante. +NETWORK +CLARITY +SKILL',
        stat:{
          NETWORK:2,
          CLARITY:1,
          SKILL:1
      ...
      contribute:{
        msg:'Porti valore specifico. +NETWORK +SKILL',
        stat:{
          NETWORK:2,
          SKILL:1
        }
      ...
      expand:{
        msg:'Espandi subito il nucleo. +NETWORK +RADAR',
        stat:{
          NETWORK:3,
          RADAR:1
        }
    ...
    db:{
      pat:'Le community professionali come infrastruttura di carriera per il lavoro autonomo',
  ...
  },
  {
    id:'piva_tech2',
    sprite:'tech',
    label:'Proposta complessa',
    type:'tech',
    required:false,
    gridX:14,
    gridY:6,
    dlg:{
      spk:'💻 Sfida Tecnica — P.IVA 2',
      color:'#f7c46a',
      ...
      chs:[
        {
          t:'RAG è quasi sempre la scelta giusta con 5000 ticket: aggiornabile senza retraining, interpretabile, nei costi.',
          out:'rag'
        },
        {
          t:'Dipende dal tipo di domande. Se sono domande su policy e prodotti, RAG. Se richiedono ragionamento complesso, prompt engineering prima.',
          out:'depends'
        },
        {
          t:'Prima faccio un\'analisi dei 5000 ticket per capire la distribuzione delle domande — poi scelgo l\'architettura.',
          out:'data_first'
        }
      ]
    },
    outs:{
      rag:{
        msg:'Scelta corretta e ben motivata. +SKILL +CLARITY',
        stat:{
          SKILL:2,
          CLARITY:1
        }
      ...
      depends:{
        msg:'Risposta sfumata che mostra comprensione profonda. +SKILL +RADAR',
        stat:{
          SKILL:2,
          RADAR:1
        }
      ...
      data_first:{
        msg:'Dati prima dell\'architettura. +SKILL +CLARITY +RADAR',
        stat:{
          SKILL:1,
          CLARITY:2,
          RADAR:1
    ...
    db:{
      pat:'RAG vs fine-tuning vs prompt engineering: quando usare cosa',
